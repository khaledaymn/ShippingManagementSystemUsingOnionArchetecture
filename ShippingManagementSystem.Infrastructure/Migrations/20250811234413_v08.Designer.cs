            ...
            modelBuilder.Entity("ShippingManagementSystem.Domain.Entities.GroupMedule", b =>
                {
                    ...
                    b.HasKey("MeduleId", "GroupId", "Permission");

                    b.HasIndex("GroupId");

                    b.ToTable("GroupMedules");
                });
            ...
            modelBuilder.Entity("ShippingManagementSystem.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("ShippingRepresentativeId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ShippingRepresentativeId");
            ...
            modelBuilder.Entity("ShippingManagementSystem.Domain.Entities.ShippingRepGovernorate", b =>
                {
                    ...
                    b.ToTable("ShippingRepGovernorates");
                });
            ...
            modelBuilder.Entity("ShippingManagementSystem.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("ShippingManagementSystem.Domain.UserTypes.ShippigRepresentative", "ShippingRepresentative")
                        .WithMany("ShippigRepresentativeOrders")
                        .HasForeignKey("ShippingRepresentativeId");
                    ...
                    b.Navigation("ShippingRepresentative");
                });
